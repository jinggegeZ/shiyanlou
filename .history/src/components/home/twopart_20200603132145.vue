            ...
            <div class="left">
                <div class="l-item" v-for="(item,index) in arr" :key="index">
                    ...
                    <div class="item-b" :style="{ top: index > 3 ? ((-57 * (index-4))-40)+'px' : '0px' }">
                            ...
                            <div class="itemb-2">
                                <a class="itemb-3" v-for="(item1,index1) in item.tags" :key="index1">{{item1.name}}</a>
                            </div>
                            <div class="itemb-1">课程推荐</div>
                            <div class="itemb-4" v-for="(item2,index2) in item.recommend_courses" :key="index2">{{item2.name}}</div>
                        </div>
                </div>
            </div>
        </div>
